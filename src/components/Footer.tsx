      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <a 
                href="https://twitter.com/acadmeysash" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-white shadow-subtle flex items-center justify-center text-secondary/70 hover:text-secondary transition-colors duration-300"
                aria-label="EdVix on Twitter"
              >
              ...
              <a 
                href="https://instagram.com/avadeshsharmaonline" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-white shadow-subtle flex items-center justify-center text-secondary/70 hover:text-secondary transition-colors duration-300"
                aria-label="EdVix on Instagram"
              >
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-secondary/60">
            &copy; 2025 EdVix. All rights reserved.
          </p>
