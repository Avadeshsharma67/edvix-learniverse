            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button type="button" className="w-full py-2.5 px-5 bg-white border border-gray-200 text-sm rounded-lg flex items-center justify-center hover:bg-gray-50 transition-colors">
